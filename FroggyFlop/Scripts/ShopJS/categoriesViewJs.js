$(function () {
    ...
    $("table#cats input.text-box").dblclick(function () {
        originalTextBoxValue = $(this).val();
        $(this).attr("readonly", false);
    });

    $("table#cats input.text-box").keyup(function (e) {
        if (e.keyCode == 13) {
            $(this).blur();
        }
    });

    $("table#cats input.text-box").blur(function () {
        var $this = $(this);
    ...
    var table = $("table#cats tbody"); /*Класс таблицы вывода*/
        ...
        $.post(url, { catName: catName }, function (data) {
            ...
            if (response == "titletaken") {
                ...
                if (!$("table#cats").length) {
                    ...
                    var toAppend = $("table#cats tbody tr:last").clone();
    ...
    /* Confirm cat delition*/////////////////////////////////////////

    $("a.delete").click(function () { return confirm("Confirm category delition") });

    /////////////////////////////////////////////////////////////////

    /* Sorting script *///////////////////////////////////////////////

    $("table#cats tbody").sortable({
        items: "tr:not(.home)",
        placeholder: "ui-state-highlight",
        update: function () {
            var ids = $("table#cats tbody").sortable("serialize");
